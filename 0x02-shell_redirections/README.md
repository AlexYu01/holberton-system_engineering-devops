...
The project includes various tasks involving redirection of standard output/input of files. Shell commands that were heavily used in these tasks are of the following: **echo, cat, head, tail, find, wc, sort, uniq, grep, tr, rev, cut**. Commands such as **sed** and **awk** were not allowed in the tasks.
...
7. Write a shell script that creates a file named exactly *\*\\'"Holberton School"\'\\*$\?\*\*\*\*\*:)* containing the text Holberton 
